...
export async function setup(
  ...
  emailInputs.dmarcPolicy = opts.dmarcPolicy ?? 'none'
  ...
  await dnsDef.setupRecords({ domain: zone, records: adjustedRecords, verificationPrefix, confirm, dryRun }, dnsInputs)
}
